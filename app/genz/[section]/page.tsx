...
const catalog = {
  dresses: { title: 'GenZ Dresses', description: 'Dress', brands: ['H&M', 'Zara', 'Urbanic', 'Style Union'], files: ['dress1.avif', 'dress2.avif', 'dress3.avif', 'dress4.avif', 'dress5.avif'] },
  tops: { title: 'GenZ Tops', description: 'Top', brands: ['H&M', 'Zara', 'Urbanic', 'ONLY'], files: ['top1.avif', 'top2.avif', 'top3.avif', 'top4.avif', 'top5.avif'] },
  'women-jeans': { title: 'GenZ Women Jeans', description: 'Jeans', brands: ['Levis', 'Zara', 'Flying Machine', 'ONLY'], files: ['jeans1.avif', 'jeans2.avif', 'jeans3.avif', 'jeans4.avif', 'jeans5.avif'] },
  trousers: { title: 'GenZ Trousers', description: 'Trouser', brands: ['H&M', 'Zara', 'Urbanic', 'AND'], files: ['trousers1.avif', 'trousers2.avif', 'trousers3.avif', 'trousers4.avif', 'trousers5.avif'] },
  'women-t-shirts': { title: 'GenZ Women T-Shirts', description: 'T-Shirt', brands: ['H&M', 'Mango', 'Levis', 'U.S. Polo Assn.'], files: ['tshirt1.avif', 'tshirt2.avif', 'tshirt3.avif', 'tshirt4.avif', 'tshirt5.avif'] },
  bras: { title: 'GenZ Bras', description: 'Bra', brands: ['Clovia', 'Zivame', 'Amante', 'Jockey'], files: ['bra1.avif', 'bra2.avif', 'bra3.avif', 'bra4.avif', 'bra5.avif'] },
  ...
  'men-t-shirts': { title: 'GenZ Men T-Shirts', description: 'T-Shirt', brands: ['H&M', 'Urbanic', 'Levis', 'Style Union'], files: ['tshirt1.avif', 'tshirt2.avif', 'tshirt3.avif', 'tshirt4.avif', 'tshirt5.avif'] },
  shirts: { title: 'GenZ Shirts', description: 'Shirt', brands: ['Zara', 'H&M', 'Urbanic', 'ONLY'], files: ['top1.avif', 'top2.avif', 'top3.avif', 'top4.avif', 'top5.avif'] },
  'men-jeans': { title: 'GenZ Men Jeans', description: 'Jeans', brands: ['Levis', 'Wrangler', 'Lee', 'Flying Machine'], files: ['jeans1.avif', 'jeans2.avif', 'jeans3.avif', 'jeans4.avif', 'jeans5.avif'] },
