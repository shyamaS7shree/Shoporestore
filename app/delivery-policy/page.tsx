    ...
    <main className="min-h-screen bg-[#fff7ed] pb-20 pt-[92px] text-[#2a1c14]">
      <section className="mx-auto max-w-[1240px] px-4 sm:px-6">
        <div className="grid overflow-hidden rounded-[30px] border border-orange-200 bg-white shadow-[0_22px_65px_rgba(154,76,20,0.09)] lg:grid-cols-[1fr_340px]">
          <div className="px-7 py-11 sm:px-11 lg:px-14 lg:py-14"><p className="text-[10px] font-black uppercase tracking-[0.22em] text-orange-600">Delivery policy</p><h1 className="mt-4 max-w-[700px] text-[40px] font-black leading-[1.08] tracking-[-0.04em] sm:text-[52px]">Clear updates from checkout to doorstep.</h1><p className="mt-6 max-w-[680px] text-[14px] leading-7 text-[#78675d]">Delivery estimates are shown before and after ordering, with progress available anytime from your account.</p></div>
